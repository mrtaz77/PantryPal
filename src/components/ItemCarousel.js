...
function ItemCarousel({ items, onDecrementClick, onIncrementClick, onDeleteClick }) {
    ...
    if(items.length < 4) {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            // Stop when the last group contains the original first item
            if ((i + 2) % items.length === 0 && i !== 0) break;
        }
    }
    ...
    return (
        <Carousel
            ...
            navButtonsAlwaysVisible={true} // Keep the navigation buttons always visible
        >
